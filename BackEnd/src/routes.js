...
//   );
//   app.post("/api/auth/checkMazaToken", AuthenticationController.checkMazaToken);
//   app.post(
//     "/api/auth/verifyMazaToken",
//     AuthenticationController.verifyMazaToken
//   );
//   app.post("/api/auth/resetPassword", AuthenticationController.resetPassword);
//   app.post("/api/auth/resetMazaToken", AuthenticationController.resetMazaToken);

//   // category
//   app.get(
//     "/api/category/getCategoryByName/:name",
...
//   // checkout
//   app.post(
//     "/api/checkout/createCheckoutSession",
//     CheckoutController.createCheckoutSession
//   );
//   app.get(
//     "/api/checkout/retrieveCheckoutSession/:sessionId",
...
//   // showcase
//   app.get(
//     "/api/showcase/getShowcaseItems",
//     ShowcaseController.getShowcaseItems
//   );
//   app.post(
//     "/api/showcase/createShowcaseItem",
//     isAuthenticated,
//     ShowcaseController.createShowcaseItem
//   );
//   app.put(
//     "/api/showcase/updateShowcaseItem",
//     isAuthenticated,
//     ShowcaseController.updateShowcaseItem
//   );
//   app.delete(
//     "/api/showcase/deleteShowcaseItem/:showcaseItemId",
//     isAuthenticated,
...
//   // sub category
//   app.get(
//     "/api/subCategory/getSubCategoryByName/:name",
//     SubCategoryController.getSubCategoryByName
//   );
//   app.get(
//     "/api/subCategory/getSubCategoryList",
...
//   // sub sub Category
//   app.get(
//     "/api/subSubCategory/getSubSubCategoryByName/:name",
//     SubSubCategoryController.getSubSubCategoryByName
//   );
//   app.get(
//     "/api/subSubCategory/getSubSubCategoryList",
//     SubSubCategoryController.getSubSubCategoryList
//   );
//   app.post(
//     "/api/subSubCategory/createSubSubCategory",
//     SubSubCategoryController.createSubSubCategory
//   );
//   app.put(
//     "/api/subSubCategory/updateSubSubCategory",
...
//   );
//   app.get(
//     "/api/wishlist/getWishlistItem/:productId",
//     isAuthenticated,
//     WishlistController.getWishlistItem
//   );
//   app.post(
//     "/api/wishlist/createWishlistItem",
//     isAuthenticated,
//     WishlistController.createWishlistItem
//   );
//   app.delete(
//     "/api/wishlist/removeWishlistItem/:productId",
//     isAuthenticated,
//     WishlistController.removeWishlistItem
//   );
//   app.delete(
//     "/api/wishlist/deleteWishItemByProduct/:productId",
//     isAuthenticated,
